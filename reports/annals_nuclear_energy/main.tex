...
Nuclear data is considered the major source of uncertainty in several reactor observables, most notably the effective multiplication factor (\keff{}). The nuclear data available in evaluated nuclear data libraries, such as cross sections, neutron multiplicities, angular distributions, and fission neutron energy spectra, are the result of a complex fitting procedure involving theoretical models, microscopic experiments, and expert judgment. Integral experiments are subsequently used to assess the performance of this nuclear data and provide feedback to further fine-tune nuclear data. In this work, a Bayesian Optimization (BO) framework is proposed to consolidate microscopic energy-dependent measurements with integral experiments for the estimation of nuclear data parameters.
...
Covariance matrices $\Sigma_\sigma$ were generated using SANDY~\cite{fioritoJEFF33CovarianceApplication2019} (wrapping the NJOY2016~\cite{muirNJOYNuclearData} nuclear data processing code). The Sandwich formula \cite{broadheadSensitivityUncertaintyBasedCriticality2004} is used to propagate these uncertainties to \keff{}, it is given by
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\linewidth]{../figures/sensitivity_hmi001+pmi002_Cr53.png}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{../figures/XS_fit_nTOF1.png}
  \caption{Capture yield}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{../figures/cr53_capture_xs_samples1.png}
...
The authors gratefully acknowledge the financial support of the Fonds de la Recherche Scientifique (F.R.S.-FNRS) and the ENEN2plus project. The ENEN2plus project has received funding from the Euratom research and training programme 2021-2025 under grant agreement No 101061677. The authors also like to thank Sara Maccario for providing a set of scripts which helped speed up development. The help of Pablo Pérez-Maroto was also greatly appreciated for providing input files for SAMMY and help troubleshooting. The knowledge of Peter Schillebeekx was immensely useful to help understand the microscopic experiments. 
